          ...
          <div class="col-12 ">
            <div class="payment">
              <ul class="payment_icon">
                <li class="visa"><a href="#"><img src="{{ asset('img/pay1.png') }}" alt="Stylexpo"></a></li>
                <li class="discover"><a href="#"><img src="{{ asset('img/pay2.png') }}" alt="Stylexpo"></a></li>
                <li class="paypal"><a href="#"><img src="{{ asset('img/pay3.png') }}" alt="Stylexpo"></a></li>
                <li class="vindicia"><a href="#"><img src="{{ asset('img/pay4.png') }}" alt="Stylexpo"></a></li>
                <li class="atos"><a href="#"><img src="{{ asset('img/pay5.png') }}" alt="Stylexpo"></a></li>
              </ul>
            </div>
          </div>
        </div>
